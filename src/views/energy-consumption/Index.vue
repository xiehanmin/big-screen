<template>
    <div id="big_screen" class="bg" ref="appRef">
        ...
        <div v-else class="host-body">
            <div class="host_body_top">
                ...
                <div class="top_right">
                    <div class="host_body_top_minTitle1">
                        <span @click="$router.push('/environmental-monitoring')"
                            >环境监测看板</span
                        >
                    </div>
                    <div>
            ...
            <div style="margin-top: 60px">
                <ScreenOne style="height: 400px; margin-bottom: 40px" />
                <ScreenTwo />
            </div>
        </div>
    </div>
...
export default {
    ...
    components: { ScreenOne, ScreenTwo },
    mounted() {
        this.timeFn();
        this.cancelLoading();
    },
